	...
	return (
		<>
			<div>
				...
				<div>
					<strong className={styles.HeadlineLinks}>Gender</strong>
					<span className={styles.FieldValue}> - {gender}</span>
				</div>
				<div>
					<strong className={styles.HeadlineLinks}>Hair color</strong>
					<span className={styles.FieldValue}> - {hair_color}</span>
				</div>
				<div>
					<strong className={styles.HeadlineLinks}>Height</strong>
					<span className={styles.FieldValue}> - {height} cm</span>
				</div>
				<div>
					<strong className={styles.HeadlineLinks}>Mass</strong>
					<span className={styles.FieldValue}> - {mass} kg</span>
				</div>
				<div>
					<strong className={styles.HeadlineLinks}>Homeworld</strong> :{" "}
					{checkId(planets, homeworld) ? (
						planets?.map(
							(doc) =>
								doc.data().url === homeworld && (
			...
			<div>
				{" "}
				<strong className={styles.HeadlineLinks}>Starships </strong>:
			...
			<div>
				{" "}
				<strong className={styles.HeadlineLinks}> Other characters: </strong>:{" "}
				{charactersList?.map(
					(doc) =>
						doc.data().url !== url && (
							<span key={doc.data().url} className={styles.elementSearching}>
